...
Pasos a seguir: 
# Crear una carpeta para contener el proyecto.
# Click derecho dentro de la carpeta creada y abrir una terminal de Gitbash.
# Dentro de la terminal ejecutar el siguiente comando:
